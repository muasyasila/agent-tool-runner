      ...
      {showAbout && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={() => setShowAbout(false)}>
          <div className="bg-gray-800 rounded-xl max-w-2xl w-full p-6 border border-gray-700" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-gray-300 mb-3">AI-powered agent that understands natural language and executes tools like calculator, time, and echo.</p>
            <p className="text-gray-400 text-sm mb-2">Built with React, FastAPI, PostgreSQL, and Groq AI.</p>
            <p className="text-gray-400 text-sm">Try: "What's 15 percent of 200?" or "Add 5 and 7 then multiply by 2"</p>
